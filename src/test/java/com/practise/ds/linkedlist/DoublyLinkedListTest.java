...
public class DoublyLinkedListTest {
	...
	public void testCustomLinkedList() {
		...
		Assert.assertEquals(list.toString(), "[Mohan, Raj, Kishore, "
				+ "Sanjeev, Akash, Sanjeev, Asha, Rajesh]");

		Assert.assertEquals(list.poll(), "Mohan");
		Assert.assertEquals(list.peek(), "Raj");
		Assert.assertEquals(list.size(), 7);

		Assert.assertEquals(list.toString(), "[Raj, Kishore, Sanjeev, "
				+ "Akash, Sanjeev, Asha, Rajesh]");

		Assert.assertEquals(list.remove(), "Raj");
		Assert.assertEquals(list.peek(), "Kishore");
		Assert.assertEquals(list.size(), 6);
		Assert.assertEquals(list.toString(), "[Kishore, Sanjeev, Akash, "
				+ "Sanjeev, Asha, Rajesh]");
		...
		com.practise.ds.linkedlist.DoublyLinkedList<String> customlist = 
				new com.practise.ds.linkedlist.DoublyLinkedList<>();
		...
		Assert.assertEquals(customlist.toString(), "[Mohan, Raj, Kishore, Sanjeev, "
				+ "Akash, Vikash, Sanjeev, Asha, Rajesh]");
		...
		Assert.assertEquals(customlist.toString(), "[Raj, Kishore, Sanjeev, Akash, "
				+ "Sanjeev, Asha, Rajesh]");
		...
		Assert.assertEquals(customlist.toString(), "[Kishore, Sanjeev, Akash, "
				+ "Sanjeev, Asha, Rajesh]");
		...
		customlist.insertNodeAtPosition(0, "Ram");
		Assert.assertEquals(customlist.indexOf("Ram"), 0);
		Assert.assertEquals(customlist.size(), 9);
		
		Assert.assertEquals(customlist.toString(),
				"[Ram, Kishore, Sanjeev, Akash, Mohan, Sanjeev, Asha, Rajesh, Rakesh]");
	...
	public void testGet() {
		...
		Assert.assertEquals(customlist.get(0), "Mohan");
		Assert.assertEquals(customlist.get(1), "Raj");
		Assert.assertEquals(customlist.get(2), "Kishore");
		Assert.assertEquals(customlist.get(3), "Sanjeev");
		Assert.assertEquals(customlist.get(4), "Akash");
		Assert.assertEquals(customlist.get(5), "Vikash");
		Assert.assertEquals(customlist.get(6), "Sanjeev");
		Assert.assertEquals(customlist.get(7), "Asha");
	}
