...
import com.practise.ds.stack.StackWithArray;
...
public class StackWithArrayTest {
	...
	public void testStackApis() {
		...
		Assert.assertEquals(stack.toString(), "[0, 5, 2, 9, 7, 1, 8, 4, 6, 3]");
		...
		// Custom stack
		StackWithArray customStack = new StackWithArray();
		...
		Assert.assertEquals(customStack.toString(), "[0, 5, 2, 9, 7, 1, 8, 4, 6, 3]");
