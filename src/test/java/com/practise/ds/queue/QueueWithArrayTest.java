...
import com.practise.ds.queue.QueueWithArray;
...
public class QueueWithArrayTest {
	...
	public void testStackApis() {
		...
		// Custom stack
		QueueWithArray customQueue = new QueueWithArray();
		...
		Assert.assertEquals(customQueue.poll(), new Integer(5));
	...
	public void testPoll() {
		...
		Assert.assertEquals(customQueue.poll(), new Integer(0));
		...
		customQueue.add(6);
		customQueue.add(3);
		Assert.assertEquals(customQueue.poll(), new Integer(8));
